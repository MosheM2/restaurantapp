...
class IndexTiga extends StatelessWidget {
  const IndexTiga({Key? key}) : super(key: key);
            ...
            SizedBox(
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Image.network(
                    '${gridContentRecommended.elementAt(2)['images']}',
                  ),
                ),
              ),
            ),
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        "${gridContentRecommended.elementAt(2)["subtitle"]}",
                        style: GoogleFonts.poppins(
                          fontSize: 24,
                    ...
                    Padding(
                      ...
                      child: Text(
                        "${gridContentRecommended.elementAt(2)["price"]}",
                        style: GoogleFonts.poppins(
