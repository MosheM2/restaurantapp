...
class IndexSatu extends StatelessWidget {
  const IndexSatu({Key? key}) : super(key: key);
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        "${gridContentRecommended.elementAt(0)["subtitle"]}",
                        style: GoogleFonts.poppins(
                          fontSize: 24,
                    ...
                    Padding(
                      ...
                      child: Text(
                        "${gridContentRecommended.elementAt(0)["price"]}",
                        style: GoogleFonts.poppins(
